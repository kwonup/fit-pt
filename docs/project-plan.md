...
| 영역 | 기술 | 배포 |
|---|---|---|
| Frontend | Next.js 15, TypeScript, Tailwind CSS | Vercel (Root: apps/web) |
...
### Phase 2 — 인증 & 프로필
- [ ] Supabase Auth 이메일 로그인/가입 구현
- [ ] 로그인 / 회원가입 페이지 UI
- [ ] 로그인 후 프로필 미설정 시 온보딩 리다이렉트
- [ ] 프로필 설정 페이지 (목표, 숙련도, 페르소나 선택)
- [ ] FastAPI 인증 토큰 검증 테스트
